...
![输入图片说明](/imgs/2022-11-05/9VmaECJ25gSBgqyJ.png)
 3.  python读取文本并提取ip
```
import re  
import json  
...
```
得到纯ip文本 
![输入图片说明](/imgs/2022-11-05/heyxZ2wlDPEEZvvr.png)
 4. 用python的requests进行get请求，只取响应状态码200的ip，返回的几乎都是可以访问的url
![输入图片说明](/imgs/2022-11-05/pV3V87aNCw1qtcWk.png)
...
if __name__ == '__main__':  
    ...
    code_check(ip)
```
![输入图片说明](/imgs/2022-11-05/vCGFpJJjUAHNYVuG.png)
![输入图片说明](/imgs/2022-11-05/ayzCe2k4duqdbTXo.png)
![输入图片说明](/imgs/2022-11-05/R8fPTaG2WztUZkTW.png)
[图片上传中...(image-IcmfcZp7swBBBPoh)]
![输入图片说明](/imgs/2022-11-05/OTsqhdK3X2MRBeon.png)
![输入图片说明](/imgs/2022-11-05/TfQeFeJ7sXK9XVAk.png)
![输入图片说明](/imgs/2022-11-05/rxgK85nSRt95fOyI.png)
![输入图片说明](/imgs/2022-11-05/YBuEvqVfUrCm2aGy.png)
![输入图片说明](/imgs/2022-11-05/jy1Cb6vEZVwzoHKC.png)
![输入图片说明](/imgs/2022-11-05/43FCcNpS4eIZWXXP.png)
